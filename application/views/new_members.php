<div id="quickprofilelarge">
	...
	<a href="<?php echo base_url('users/list_latest/women'); ?>">Nouvelles femmes pour rencontre</a> | 
	<a href="<?php echo base_url('users/list_latest/men'); ?>">Nouveaux hommes pour rencontre</a>
</div>
<?php
//var_dump($members);
...
<p><a href="<?php echo base_url("message/$member->pseudo"); ?>">Envoyer message</a></p>
